...
app.post("/message", (req, res) => {
  ...
  if (message == "how are you") {
    ...
    res.send({
      message:
        "I don't have an answer to your question. I will create a ticket to the Sequoia team and have them look at the issue. Can you please confirm by entering your email?",
    });
  } else if (message == "thang.phan@internetbrands.com") {
    res.send({
      message:
        "Thank you, Thang! When the ticket is created, you will receive an email from Sequoia team.",
    });
  } else if (message == "thank you") {
    res.send({ message: "My pleasure!" });
  } else if (message == "how can i submit a partial chapter") {
    res.send({
      message: "You have to submit all of the assignments, not partially.!",
    });
  } else {
